...
class HouseholdChemicals(Product):
    ...
    """
    def __init__(self, name, price, brand, purpose, ingredients, category):
        super().__init__(name, price)
        self.brand = brand
    ...
    def get_details(self):
        return f"Бытовая химия: {self.name}, Цена: {self.price} руб, Брэнд: {self.brand}, Назначение: {self.purpose}, Состав: {self.ingredients}, Тип: {self.category}"
